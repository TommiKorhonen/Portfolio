        ...
        <header className="centerFlex min-h-screen p-5 max-w-4xl m-auto" id="home" name="home">
                <div className="centerFlex flex-col m-auto relative">
                    <div>
                        <h1 id="title" className=" text-5xl sm:text-6xl uppercase font-bold max-w-md">
                            {spanData.map((info) => {
                                ...
                                return(
                                    <span key={id} className="activespan">{letter}</span>
                                )
                            })}
                            </h1>
                    ...
                    <div className="flex items-center flex-wrap gap-4 sm:gap-16 relative  sm:-left-14">
                        <Link to="contact" spy={true} smooth={true} duration={800} className="btn uppercase sm:animate-bounce centerFlex gap-2 cursor-pointer">
                            Hire Me
